...
storage.py — SQLite table of user_id -> provider, encrypted API key, model. Keys are encrypted with Fernet using STORAGE_SECRET.
...
Setup
Create a bot with @BotFather on Telegram and
